...
function main(servicesPath, additionalServices) {
  ...
  var version = luxnode.version;
  var create = luxnode.scaffold.create;
  var add = luxnode.scaffold.add;
  var start = luxnode.scaffold.start;
  var remove = luxnode.scaffold.remove;
  var callMethod = luxnode.scaffold.callMethod;
  var findConfig = luxnode.scaffold.findConfig;
  var defaultConfig = luxnode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the lux database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `lux-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ lux-node add wallet-service');
      console.log('    $ lux-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ lux-node remove wallet-service');
      console.log('    $ lux-node remove insight-api');
      console.log();
    });
